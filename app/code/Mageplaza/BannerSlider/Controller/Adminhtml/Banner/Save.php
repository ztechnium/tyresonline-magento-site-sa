...
class Save extends Banner
{
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->getPost('banner')) {
            ...
            /* start extra added code */
            if (isset($_FILES['brand_logo'])) {
                $this->imageHelper->uploadImage($data, 'brand_logo', Image::TEMPLATE_MEDIA_TYPE_BANNER, $banner->getImage());
            }
            if (isset($_FILES['banner_image_two'])) {
                $this->imageHelper->uploadImage($data, 'banner_image_two', Image::TEMPLATE_MEDIA_TYPE_BANNER, $banner->getImage());
            }
            if (isset($_FILES['banner_image_three'])) {
                $this->imageHelper->uploadImage($data, 'banner_image_three', Image::TEMPLATE_MEDIA_TYPE_BANNER, $banner->getImage());
            }
            if (isset($_FILES['image_ar'])) {
                $this->imageHelper->uploadImage($data, 'image_ar', Image::TEMPLATE_MEDIA_TYPE_BANNER, $banner->getImage());
            }
            if (isset($_FILES['banner_image_two_ar'])) {
                $this->imageHelper->uploadImage($data, 'banner_image_two_ar', Image::TEMPLATE_MEDIA_TYPE_BANNER, $banner->getImage());
            }
            if (isset($_FILES['banner_image_three_ar'])) {
                $this->imageHelper->uploadImage($data, 'banner_image_three_ar', Image::TEMPLATE_MEDIA_TYPE_BANNER, $banner->getImage());
            }
