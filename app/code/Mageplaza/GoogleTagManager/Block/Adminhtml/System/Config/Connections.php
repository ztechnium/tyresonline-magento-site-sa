 ...
 */
class Connections extends Field
{
    /**
     * @var string
     */
    protected $_template = 'Mageplaza_GoogleTagManager::system/config/connections.phtml';
    ...
    {
        $values            = [];
        $customConnections = $this->helperData->getConnections();
        $options           = $customConnections ? Data::jsonDecode($customConnections) : [];
