...
namespace Mageplaza\GoogleTagManager\Block\Adminhtml\System\Config\GA;
...
/**
 * Class Dimensions
 * @package Mageplaza\GoogleTagManager\Block\Adminhtml\System\Config\GA
 */
class Dimensions extends Field
{
     ...
     * @var string
     */
    protected $_template = 'Mageplaza_GoogleTagManager::system/config/ga/dimensions.phtml';
    ...
    {
        $values           = [];
        $customDimensions = $this->helperData->getGADimensions();
