...
class Image extends \Magento\Framework\View\Element\Template
{
    ...
    public function getImageUrl()
    {
        ...
        if ($product->getTypeId() == \Magento\ConfigurableProduct\Model\Product\Type\Configurable::TYPE_CODE) {
            ...
            if (!empty($assPro)) {
                $imageUrl = $this->_objectManager->get('Chetu\Ajaxcart\Helper\Data')->getProductImageUrl($assPro, 'category');
            } else {
                $imageUrl = $this->_objectManager->get('Chetu\Ajaxcart\Helper\Data')->getProductImageUrl($product, 'category');
            }
        } else {
            $imageUrl = $this->_objectManager->get('Chetu\Ajaxcart\Helper\Data')->getProductImageUrl($product, 'category');
        }
