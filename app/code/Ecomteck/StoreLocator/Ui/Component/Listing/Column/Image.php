...
namespace Ecomteck\StoreLocator\Ui\Component\Listing\Column;
...
class Image extends Column
{
    ...
    /**
     * @var \Ecomteck\StoreLocator\Model\Uploader
     */
    public $imageModel;
     ...
     * @param \Ecomteck\StoreLocator\Model\Uploader $imageModel
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach($dataSource['data']['items'] as & $item) {
                ...
                $item[$fieldName . '_link'] = $this->urlBuilder->getUrl(
                    'ecomteck_storelocator/stores/edit',
