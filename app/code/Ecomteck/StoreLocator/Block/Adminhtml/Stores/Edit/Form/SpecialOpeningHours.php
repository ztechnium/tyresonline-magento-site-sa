...
class SpecialOpeningHours extends \Magento\Backend\Block\AbstractBlock
{
    ...
    private function getForm()
    {
        ...
        if ($this->getStore() && $this->getStore()->getSpecialOpeningHours()) {
            $openingHoursFieldset->setSpecialOpeningHours($this->getStore()->getSpecialOpeningHours());
        }

        $openingHoursRenderer = $this->getLayout()->createBlock('Ecomteck\StoreLocator\Block\Adminhtml\Stores\Edit\Form\SpecialOpeningHours\Container\Renderer');
