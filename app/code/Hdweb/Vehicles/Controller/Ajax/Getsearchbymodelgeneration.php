...
class Getsearchbymodelgeneration extends \Magento\Framework\App\Action\Action
{	
	protected $_resource;
    ...
    public function execute()
    {
		...
		$searchby_model_url = "https://api.wheel-size.com/v2/search/by_model/?user_key=".$wheelApiKey."&make=".$make."&model=".$model."&generation=".$generation."&modification=".$modification."";
				...
				if ($tyrevalue->rear->tire_width) {
                    if (isset($enginesTyre[$slug])) {
						...
						if($tyrevalue->is_stock){
							$oemClass ='oem';
                            $tyreSize = 'FACTORY TYRE SIZE';
                            $tyreSizeClass = '';
						}else{
                            $tyreSize = 'OPTIONAL TYRE SIZE';
                            $tyreSizeClass = 'optional';
                        }
                        ...
                        $enginesTyre[$tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire].= '<li>
                                                                                                     <a href="#" class="box '.$tyreSizeClass.'" onclick="vehiclesShowProduct(\'' . $tyrevalue->front->tire_width . '\',\'' . $tyrevalue->front->tire_aspect_ratio . '\',\'' . $tyrevalue->front->rim_diameter . '\',\'' . $tyrevalue->rear->tire_width . '\',\'' . $tyrevalue->rear->tire_aspect_ratio . '\',\'' . $tyrevalue->rear->rim_diameter . '\')">
                                                                                                          <div class="label"><span>'.$tyreSize.'</span></div>
                                                                                                          <strong>'.$tyrevalue->front->rim_diameter.'”</strong>
                                                                                                          <p>'. $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire .'</p>
                                                                                                     </a>
                                                                                                </li>';
                    } else {
						if($tyrevalue->is_stock){
                    ...
                    if (isset($enginesTyre[$slug])) {
                        ...
                        $enginesTyre[$tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire].= '<li>
                                                                                                     <a href="#" class="box '.$tyreSizeClass.'" onclick="vehiclesShowProduct(\'' . $tyrevalue->front->tire_width . '\',\'' . $tyrevalue->front->tire_aspect_ratio . '\',\'' . $tyrevalue->front->rim_diameter . '\')">
                                                                                                          <div class="label"><span>'.$tyreSize.'</span></div>
                                                                                                          <strong>'.$tyrevalue->front->rim_diameter.'”</strong>
                                                                                                          <p>'.$tyrevalue->front->tire.'</p>
                                                                                                     </a>
                                                                                                </li>';
                    } else {
						if($tyrevalue->is_stock){
