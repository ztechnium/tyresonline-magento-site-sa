...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('The Supplier products has been saved.'));
                $this->_objectManager->get('Magento\Backend\Model\Session')->setFormData(false);
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath('*/*/edit', ['supplierproducts_id' => $model->getId(), '_current' => true]);
                }
            ...
            return $resultRedirect->setPath('*/*/edit', ['supplierproducts_id' => $this->getRequest()->getParam('supplierproducts_id')]);
        }
        return $resultRedirect->setPath('*/*/');
    }
}