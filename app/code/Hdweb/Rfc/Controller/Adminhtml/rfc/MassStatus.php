...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('rfc');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Hdweb\Rfc\Model\Rfc')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('rfc/*/index');
    }
