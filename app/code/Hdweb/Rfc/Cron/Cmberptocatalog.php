                ...
                if (is_array($response)) {
                    ...
                    foreach ($response as $data) {
                        ...
                        if (!empty($product) || $product != null) {
                            ...
                            $successcount++;
                            $responseRowData[] = array($dataItcode, $dataDescription, $dataYear, $oldQtyArr[$productId], $dataQty, $dataQty, $oldPrice, $fittPrice, $fittPrice, 'Success', 'Updated', $pricestatus, $qtystatus, $yearstatus);
