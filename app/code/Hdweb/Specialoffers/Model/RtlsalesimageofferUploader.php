<?php
namespace Hdweb\Specialoffers\Model;
class RtlsalesimageofferUploader
{
    /**
    ...
    const DEFAULT_BASETMPATH = "salesrule/offerimage/tmp";
    const DEFAULT_BASEPATH = "salesrule/offerimage";
    /**
