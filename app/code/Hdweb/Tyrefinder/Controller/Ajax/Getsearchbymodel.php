            ...
            foreach ($enginevalue->wheels as $tyrekey => $tyrevalue) {
                ...
                /* if ($tyrevalue->rear->tire_width) {
                    if (isset($enginesTyre[$slug])) {
                        $enginesTyre[$slug] .= '<li id="li-search" class="'.$slug.'" ><a href="javascript:void(0)" onclick="showproduct(\'' . $frontwidth . '\',\'' . $frontheight . '\',\'' . $frontrim . '\',\'' . $rearwidth . '\',\'' . $rearheight . '\',\'' . $rearrim . '\')" >' . $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire . '</a><span id="autosearch-span" style="display:none">' . $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire . '</span></li>';
                    } else {
                        $enginesTyre[$slug] = '<li id="li-search" class="'.$slug.'"><a href="javascript:void(0)" onclick="showproduct(\'' . $frontwidth . '\',\'' . $frontheight . '\',\'' . $frontrim . '\',\'' . $rearwidth . '\',\'' . $rearheight . '\',\'' . $rearrim . '\')" >' . $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire . '</a><span id="autosearch-span" style="display:none">' . $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire . '</span></li>';
                    }
                    ...
                    if (isset($enginesTyre[$slug])) {
                        $enginesTyre[$slug] .= '<li id="li-search" class="'.$slug.'" ><a href="javascript:void(0)" onclick="showproduct(\'' . $frontwidth . '\',\'' . $frontheight . '\',\'' . $frontrim . '\')" >' . $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire . '</a><span id="autosearch-span" style="display:none">' . $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire . '</span></li>';
                    } else {
				...
				if ($tyrevalue->rear->tire_width) {
                    if (isset($enginesTyre[$slug])) {
                        ...
                        $enginesTyre[$tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire].= '<li class="'.$oemClass.' '.$slug.' li-search" ><a href="javascript:void(0)" class="button button-primary-grey custom-size button-block button-rounded opacity button-text-overflow front-rear-size" onclick="showproduct(\'' . $tyrevalue->front->tire_width . '\',\'' . $tyrevalue->front->tire_aspect_ratio . '\',\'' . $tyrevalue->front->rim_diameter . '\',\'' . $tyrevalue->rear->tire_width . '\',\'' . $tyrevalue->rear->tire_aspect_ratio . '\',\'' . $tyrevalue->rear->rim_diameter . '\')" >' . $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire . '</a><span id="autosearch-span" style="display:none">' . $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire . '</span></li>';
                    } else {
						if($tyrevalue->is_stock){
							$oemClass ='oem';
						}
                    ...
                    if (isset($enginesTyre[$slug])) {
                        ...
                        $enginesTyre[$tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire].= '<li class="'.$oemClass.' '.$slug.' li-search" ><a href="javascript:void(0)" class="button button-primary-grey custom-size button-block button-rounded opacity button-text-overflow" onclick="showproduct(\'' . $tyrevalue->front->tire_width . '\',\'' . $tyrevalue->front->tire_aspect_ratio . '\',\'' . $tyrevalue->front->rim_diameter . '\')" >' . $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire . '</a><span id="autosearch-span" style="display:none">' . $tyrevalue->front->tire . ' ' . $tyrevalue->rear->tire . '</span></li>';
                    } else {
						if($tyrevalue->is_stock){
							$oemClass ='oem';
						}
