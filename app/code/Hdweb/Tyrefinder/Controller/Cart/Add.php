...
class Add extends \Magento\Checkout\Controller\Cart\Add
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $hasMobileVanTyreServiceProduct = $this->_objectManager->create('Hdweb\Installer\Helper\Data')->checkHasNoMobileVanTyreServiceProduct();
            
            if(isset($_COOKIE['mobilevanservice_data'])){
                if($hasMobileVanTyreServiceProduct){
