...
class  Column extends \Lof\AdvancedReports\Helper\GoogleChart\AbstractChart{
  ...
  public function buildChartFunction($function_name, $data_columns, $data_charts, $settings, $prefix = "" ) {
      ...
      if($data_columns && $data_charts) {
        ...
        $html .= 'var chart = new google.visualization.ColumnChart(document.getElementById("'.$chart_container.'"));
