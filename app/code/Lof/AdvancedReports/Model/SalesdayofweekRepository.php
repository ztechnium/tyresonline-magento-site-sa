...
use Lof\AdvancedReports\Api\SalesdayofweekInterface;
use Lof\AdvancedReports\Model\AbstractReport;
use Magento\Framework\Api\SortOrder;
 
class SalesdayofweekRepository extends AbstractReport implements SalesdayofweekInterface
{
    protected $_limit = 10;
    /**
     * GROUP BY criteria
    ...
    public function __construct(   
        ...
        \Lof\AdvancedReports\Api\Data\SalesdayofweekdataInterfaceFactory $searchResultsFactory
        )
    {
    ...
    */
     ...
     * @return \Lof\AdvancedReports\Api\Data\SalesdayofweekdataInterface
     */
    public function getSalesDayofweek(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria) {
        $cur_month = date("m");
        $cur_year = date("Y");
        $filter_fields = [
        ...
        //init \Lof\AdvancedReports\Api\Data\SalesdayofweekdataInterface
