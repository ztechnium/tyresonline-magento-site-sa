...
use Lof\AdvancedReports\Api\CustomercityInterface;
use Lof\AdvancedReports\Model\AbstractReport;
use Magento\Framework\Api\SortOrder;
 
class CustomercityRepository extends AbstractReport implements CustomercityInterface
{
    protected $_limit = 10;
    /**
     * GROUP BY criteria
    ...
    public function __construct(   
        ...
        \Lof\AdvancedReports\Api\Data\CustomercitydataInterfaceFactory $searchResultsFactory
        )
    {
    ...
    */
     ...
     * @return \Lof\AdvancedReports\Api\Data\CustomercitydataInterface
     */
    public function getCustomerCity(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria) {
        $cur_month = date("m");
        $cur_year = date("Y");
        $filter_fields = [
