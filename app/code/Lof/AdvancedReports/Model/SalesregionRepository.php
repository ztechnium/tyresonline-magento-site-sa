...
use Lof\AdvancedReports\Api\SalesregionInterface;
use Lof\AdvancedReports\Model\AbstractReport;
use Magento\Framework\Api\SortOrder;
 
class SalesregionRepository extends AbstractReport implements SalesregionInterface
{
    protected $_limit = 10;
    /**
     * GROUP BY criteria
    ...
    public function __construct(   
        ...
        \Lof\AdvancedReports\Api\Data\SalesregiondataInterfaceFactory $searchResultsFactory
        )
    {
    ...
    */
     ...
     * @return \Lof\AdvancedReports\Api\Data\SalesregiondataInterface
     */
    public function getSalesRegion(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria) {
        $cur_month = date("m");
        $cur_year = date("Y");
        $filter_fields = [
        ...
        //init \Lof\AdvancedReports\Api\Data\SalesregiondataInterface
