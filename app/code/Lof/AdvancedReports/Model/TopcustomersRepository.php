...
use Lof\AdvancedReports\Api\TopcustomersInterface;
use Lof\AdvancedReports\Model\AbstractReport;
use Magento\Framework\Api\SortOrder;
 
class TopcustomersRepository extends AbstractReport implements TopcustomersInterface
{
    protected $_limit = 10;
    /**
     * GROUP BY criteria
    ...
    protected $_columnDate = 'main_table.created_at';
     protected $_defaultSort = 'total_profit_amount';
    ...
    public function __construct(   
        ...
        \Lof\AdvancedReports\Api\Data\TopcustomersdataInterfaceFactory $searchResultsFactory
        )
    {
    ...
    */
     ...
     * @return \Lof\AdvancedReports\Api\Data\TopcustomersdataInterface
     */
    public function getTopCustomers(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria) {
        $cur_month = date("m");
        $cur_year = date("Y");
        $filter_fields = [
