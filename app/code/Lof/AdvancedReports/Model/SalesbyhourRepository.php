...
use Lof\AdvancedReports\Api\SalesbyhourInterface;
use Lof\AdvancedReports\Model\AbstractReport;
use Magento\Framework\Api\SortOrder;
 
class SalesbyhourRepository extends AbstractReport implements SalesbyhourInterface
{
    protected $_limit = 10;
    /**
     * GROUP BY criteria
    ...
    public function __construct(   
        ...
        \Lof\AdvancedReports\Api\Data\SalesbyhourdataInterfaceFactory $searchResultsFactory
        )
    {
    ...
    */
     ...
     * @return \Lof\AdvancedReports\Api\Data\SalesbyhourdataInterface
     */
    public function getSalesByHour(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria) {
        $cur_month = date("m");
        $cur_year = date("Y");
        $filter_fields = [
        ...
        //init \Lof\AdvancedReports\Api\Data\SalesbyhourdataInterface
