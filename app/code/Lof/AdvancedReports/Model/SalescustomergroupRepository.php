...
use Lof\AdvancedReports\Api\SalescustomergroupInterface;
use Lof\AdvancedReports\Model\AbstractReport;
use Magento\Framework\Api\SortOrder;
 
class SalescustomergroupRepository extends AbstractReport implements SalescustomergroupInterface
{
    protected $_limit = 10;
    /**
     * GROUP BY criteria
    ...
    public function __construct(   
        ...
        \Lof\AdvancedReports\Api\Data\SalescustomergroupdataInterfaceFactory $searchResultsFactory
        )
    {
    ...
    */
     ...
     * @return \Lof\AdvancedReports\Api\Data\SalescustomergroupdataInterface
     */
    public function getSalesCustomergroup(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria) {
        $cur_month = date("m");
        $cur_year = date("Y");
        $filter_fields = [
        ...
        //init \Lof\AdvancedReports\Api\Data\SalescustomergroupdataInterface
