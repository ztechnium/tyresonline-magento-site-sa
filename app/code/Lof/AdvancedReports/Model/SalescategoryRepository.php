...
use Lof\AdvancedReports\Api\SalescategoryInterface;
use Lof\AdvancedReports\Model\AbstractReport;
use Magento\Framework\Api\SortOrder;
 
class SalescategoryRepository extends AbstractReport implements SalescategoryInterface
{
    protected $_limit = 10;
    /**
     * GROUP BY criteria
    ...
    protected $_columnDate = 'main_table.created_at';
     protected $_defaultSort = 'category_id';
    ...
    public function __construct(   
        ...
        \Lof\AdvancedReports\Api\Data\SalescategorydataInterfaceFactory $searchResultsFactory
        )
    {
    ...
    */
    public function initFilterData($filter_field = []) {
        ...
        if(!isset($requestData['category_id']) || !$requestData['category_id']) {
          $requestData['category_id'] = isset($filter_field['category_id'])?$filter_field['category_id']:"";
        }
     ...
     * @return \Lof\AdvancedReports\Api\Data\SalescategorydataInterface
     */
    public function getSalesCategory(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria) {
        $cur_month = date("m");
        $cur_year = date("Y");
        $filter_fields = [
    ...
    protected function _convertGridData(&$collection = null) {
        ...
        if($collection && $collection->getSize()) {
            foreach($collection as &$item) {
                ...
                $item->setData("category_name", $category_name);
