...
use Lof\AdvancedReports\Api\CustomerreportInterface;
use Lof\AdvancedReports\Model\AbstractReport;
use Magento\Framework\Api\SortOrder;
 
class CustomerreportRepository extends AbstractReport implements CustomerreportInterface
{
    protected $_limit = 10;
    /**
     * GROUP BY criteria
    ...
    public function __construct(   
        ...
        \Lof\AdvancedReports\Api\Data\CustomerreportdataInterfaceFactory $searchResultsFactory
        )
    {
    ...
    */
     ...
     * @return \Lof\AdvancedReports\Api\Data\CustomerreportdataInterface
     */
    public function getReport(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria) {
        $cur_month = date("m");
        $cur_year = date("Y");
        $filter_fields = [
    ...
    protected function _convertGridData(&$collection = null) {
        ...
        if($collection && $collection->getSize()) {
            ...
            foreach($collection as &$item) {
                ...
                $profit_currency = $this->formatCurrency($item->getTotalProfitAmount());
                $item->setData("profit_currency", $profit_currency);
                ...
                $item->setData("tax_currency", $profit_currency);
