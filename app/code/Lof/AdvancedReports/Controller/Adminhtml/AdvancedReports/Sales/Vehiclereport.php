...
class Vehiclereport extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::vehiclereport'
        )->_addBreadcrumb(
            __('Vehiclereport'),
            __('Vehiclereport')
        );
      
        $this->_registry->register('report_type', "vehiclereport"); 
        //$this->_registry->register('header_text', __("Sales Overview"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Vehiclereport'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_vehiclereport.grid');
      //  $chartBlock = $this->_view->getLayout()->getBlock('report.chart');
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'vehiclereport'); 
