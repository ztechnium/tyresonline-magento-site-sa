...
class Makemodelreport extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::makemodelreport'
        )->_addBreadcrumb(
            __('Makemodelreport'),
            __('Makemodelreport')
        );
      
        $this->_registry->register('report_type', "makemodelreport"); 
        //$this->_registry->register('header_text', __("Sales Overview"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Makemodelreport'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_makemodelreport.grid');
      //  $chartBlock = $this->_view->getLayout()->getBlock('report.chart');
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'makemodelreport'); 
