...
class Salespersonreport extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salespersonreport'
        )->_addBreadcrumb(
            __('Salesperson report'),
            __('Salesperson report')
        );
      
        $this->_registry->register('report_type', "salespersonreport"); 
        //$this->_registry->register('header_text', __("Sales Overview"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Salesperson report'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_salespersonreport.grid');
      //  $chartBlock = $this->_view->getLayout()->getBlock('report.chart');
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'salespersonreport'); 
