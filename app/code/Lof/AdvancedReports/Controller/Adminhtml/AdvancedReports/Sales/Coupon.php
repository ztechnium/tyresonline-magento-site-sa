...
class Coupon extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {     
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesbycoupon'
        )->_addBreadcrumb(
            __('Sales By Coupon'),
            __('Sales By Coupon')
        );
        ...
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_coupon.grid');  
