...
class Installerreport extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::installerreport'
        )->_addBreadcrumb(
            __('iinstallerreport'),
            __('installerreport')
        );
      
        $this->_registry->register('report_type', "installerreport"); 
        //$this->_registry->register('header_text', __("Sales Overview"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Installerreport'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_installerreport.grid');
      //  $chartBlock = $this->_view->getLayout()->getBlock('report.chart');
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'installerreport'); 
