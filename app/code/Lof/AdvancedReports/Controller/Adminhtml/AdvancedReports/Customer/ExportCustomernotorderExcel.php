...
class ExportCustomernotorderExcel extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Customer\Customernotorder
{
    /**
    ...
    { 
        $fileName = 'Customernotorder.xml';
        $grid = $this->_view->getLayout()->createBlock('Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Customer\Customernotorder\Grid'); 
