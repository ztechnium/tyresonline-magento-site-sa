...
class ExportTopcustomersExcel extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Customer\Topcustomers
{
    /**
    ...
    { 
        $fileName = 'Topcustomers.xml';
        $grid = $this->_view->getLayout()->createBlock('Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Customer\Topcustomers\Grid'); 
