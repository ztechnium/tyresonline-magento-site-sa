...
class ExportInventoryExcel extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Products\Inventory
{
    /**
    ...
    { 
        ...
        $grid = $this->_view->getLayout()->createBlock('Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Products\Inventory\Grid'); 
