...
class ExportProductSoldTogetherExcel extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Products\Productsoldtogether
{
    /**
    ...
    { 
        $fileName = 'Productsoldtogether.xml';
