 ...
 */
namespace Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Sales\Vehiclereport;
...
class Grid extends \Lof\AdvancedReports\Block\Adminhtml\Grid\AbstractGrid
{
 ...
 $this->addColumn('po_marginperc', array(
        ...
        //     'filter'    => false,
        // ));
        $this->addExportType('*/*/exportSalesVechicleCsv', __('CSV'));
    ...
    protected function _prepareCollection()
    {
        ...
        $make = $filterData->getData("make", null);
        ...
        $resourceCollection = $this->_objectManager->create($this->getResourceCollectionName())
         ...
         if(isset($make) && !empty($make)){
            ...
            $resourceCollection->addFieldToFilter('make',$make);
         }   
      ...
      //  $this->_addCustomFilter($resourceCollection, $filterData);
       ...
       // $resourceCollection->setCurPage((int) $this->getParam($this->getVarNamePage(), $this->_defaultPage));
        ...
        // } 
         ...
         // $this->_prepareTotals('po_marginperc,total_pograndtotal_amount,margin,orders_count,uniqu_orders_count,total_qtyty,inv_grand_total,total_qty_ordered,total_qty_invoiced,total_income_amount,total_revenue_amount,total_profit_amount,total_invoiced_amount,total_paid_amount,total_refunded_amount,total_tax_amount,total_tax_amount_actual,total_shipping_amount,total_shipping_amount_actual,total_discount_amount,total_discount_amount_actual,total_canceled_amount,total_subtotal_amount,total_grandtotal_amount'); 
