 ...
 */
namespace Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Sales\Makemodelreport;
 ...
 /**
    ...
    {      
       ...
       //     'totals_label'  => __('Total'),
        ...
        //     'filter'    => false,
        // ));
        $this->addExportType('*/*/exportMakemodelCsv', __('CSV'));
