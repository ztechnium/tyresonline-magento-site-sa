 ...
 * @api
 */
interface OrderdetailInterface extends \Magento\Framework\Api\CustomAttributesDataInterface
{
    /**#@-*/
    ...
    /**
     * total_subtotal_amount_currency
     *
     * @return string
     */
    ...
    /**
     * Set total_subtotal_amount_currency
     *
     * @param string $total_subtotal_amount
     * @return $this
     */
    public function setTotalSubtotalCurrency($total_subtotal_amount);

    /**
     * total_grossprofit_amount
     *
     * @return string
     */
    public function getTotalGrossprofitAmount();
    /**
     * Set total_grossprofit_amount
     *
     * @param string $total_grossprofit_amount
     * @return $this
     */
    public function setTotalGrossprofitAmount($total_grossprofit_amount);

    /**
     * total_grossprofit_amount_currency
     *
     * @return string
     */
    public function getTotalGrossprofitCurrency();

    /**
     * Set total_grossprofit_amount_currency
     *
     * @param string $total_grossprofit_amount
     * @return $this
     */
    public function setTotalGrossprofitCurrency($total_grossprofit_amount);
     ...
     * @return string
     */
    public function getMarginProfitAmount();
    /**
     * Set margin_profit_amount
     *
     * @param string $margin_profit_amount
     * @return $this
     */
    public function setMarginProfitAmount($margin_profit_amount);

    /**
     * margin_profit_amount_currency
     *
     * @return string
     */
    public function getMarginProfitAmountCurrency();

    /**
     * Set margin_profit_amount_currency
     *
     * @param string $margin_profit_amount
     * @return $this
     */
    public function setMarginProfitAmountCurrency($margin_profit_amount);
    ...
    /**
     * Set total_net_profits
     *
     * @param string $total_net_profits
     * @return $this
     */
    public function setTotalNetProfits($total_net_profits);

    /**
     * total_net_profits_currency
     *
     * @return string
     */
    public function getTotalNetProfitsCurrency();

    /**
     * Set total_net_profits_currency
     *
     * @param string $total_net_profits
     * @return $this
     */
    public function setTotalNetProfitsCurrency($total_net_profits);
