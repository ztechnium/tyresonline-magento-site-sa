...
/**
 * Add admin name to the regular comment on invoice create (add comment with create invoice action)
 */
class AddAdminNameToCommentOnInvoiceCreate extends AddAdminNameToCommentAbstract
{
    /**
    ...
    public function beforeExecute(
        ...
        if ($this->helper->isNeedToAddAdminNameToLog() && !empty($data['comment_text'])) {
            if (is_string($data['comment_text'])) {
                ...
                $request->setPostValue('invoice', $data);
            }
        }
