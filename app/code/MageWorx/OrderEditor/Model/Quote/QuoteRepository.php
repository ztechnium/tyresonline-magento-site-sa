...
use MageWorx\OrderEditor\Model\QuoteFactory as EntityFactory;
use MageWorx\OrderEditor\Api\QuoteRepositoryInterface as RepositoryInterface;
use MageWorx\OrderEditor\Model\ResourceModel\Quote as EntityResource;
use MageWorx\OrderEditor\Model\ResourceModel\Quote\CollectionFactory as EntityCollectionFactory;
...
class QuoteRepository implements RepositoryInterface
{
    ...
    public function getList(SearchCriteriaInterface $criteria, $returnRawObjects = false): SearchResultsInterface
    {
        ...
        /** @var \MageWorx\OrderEditor\Model\ResourceModel\Quote\Collection $collection */
    ...
    public function getById(int $entityId): Entity
    {
        ...
        // Allow to load quote on any website, not only on default
        $entity->setSharedStoreIds(['*']);
