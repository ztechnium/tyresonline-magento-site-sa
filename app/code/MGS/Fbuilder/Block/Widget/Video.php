...
class Video extends Template
{
    ...
    public function getYoutubeEmbed($youtube_video_id)
    {
        ...
        $embed = "//youtube.com/embed/$youtube_video_id?autoplay=$autoPlay&autohide=$autoHide&showinfo=$showInfo&controls=$control&loop=$loop&mute=$mute";
        return $embed;
    }
    /**
    ...
    public function getVimeoEmbed($vimeo_video_id)
    {
        ...
        $control = $this->getHideControl() ? '0' : '1';
        $loop = $this->getLoop() ? '1' : '0';
        $embed = "//player.vimeo.com/video/$vimeo_video_id?byline=0&portrait=0&transparent=0&autoplay=$autoPlay&loop=$loop&title=$showInfo&sidedock=$control&mute=1&api=1";
        return $embed;
    }
    /**
