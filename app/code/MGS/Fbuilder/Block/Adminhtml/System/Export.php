...
*/
        ...
        $html = '<select id="fbuilder_export_page_id" name="groups[export][fields][page_id][value]" class="select admin__control-select" data-ui-id="select-groups-export-fields-page_id-value" style="width:230px; margin-right:10px">
