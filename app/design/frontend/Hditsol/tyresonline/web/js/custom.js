...
require(['jquery', 'mage/loader'], function ($) {
	...
	$(document).on('click', ".tyres-banner .tyre-search .search-vehicle span", function() {
		$(".vehicle_make").trigger( "click" );
	});
	$(document).on('click', ".promotions-offers .offers-banner .content-wrap .tyre-search .search-vehicle span", function() {
		$(".vehicle_make").trigger( "click" );
	});
});
