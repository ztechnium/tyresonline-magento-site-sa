...
define(
    ...
    ], function ($, customerData, $t, modal, url) {
        'use strict';
        ...
        $.widget(
            'mageplaza.socialpopup', {
                options: {
                    ...
                    createSuccessLoginBtn: '.social-login.create .create-success-content .action.login',
                    formLoginUrl: '',
                    /*Email*/
                    ...
                    createFormUrl: '',
                    createSuccessFormHideContainer: '.social-login.create .create-content',
                    createSuccessShowContainer: '.social-login.create .create-success-content',
                    showFields: '',
                ...
                initObject: function () {
                    ...
                    this.createSuccessFormHideContainer = $(this.options.createSuccessFormHideContainer);
                    this.createSuccessShowContainer = $(this.options.createSuccessShowContainer);
                },
                ...
                initObserve: function () {
                    ...
                    $(this.options.createSuccessLoginBtn).on('click', this.showLogin.bind(this));
                },
                ...
                showCreate: function () {
                    ...
                    this.emailFormContainer.hide();
                    this.createSuccessFormHideContainer.show();
                    this.createSuccessShowContainer.hide();
                },
                ...
                showSuccessPopup: function () {
                    this.createSuccessFormHideContainer.hide();
                    this.createSuccessShowContainer.show();
                },
                        ...
                        function (response) {
                            ...
                            if (response.success) {
                                ...
                                if (response.redirectUrl) {
                                    ...
                                    var redirectUrl = url.build('customer/account/');
