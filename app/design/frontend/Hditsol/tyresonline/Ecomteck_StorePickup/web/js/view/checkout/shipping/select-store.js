        ...
        initialize: function () {
            ...
            ko.bindingHandlers.storepickuptimepicker = {
                ...
                update: function (element, valueAccessor,allBindingsAccessor) {
                    ...
                    var enableTimes = {};
                    var disabledTimes = [];
                    console.log(selectedStore.special_opening_hours);
        ...
        selectStoreDateTime: function () {
            if(window.checkoutConfig.storepickup !== 'undefined') {    
                    ...
                    if( pickup_store != "" &&  pickup_date != "" && pickup_time != "" && pickup_name != "" && storeJson != ""){
						...
						$('.shipping-date-div #shipping-date-ordersummary').html(pickup_date);
                        $('.shipping-date-div #shipping-time-ordersummary').html(pickup_time);						
